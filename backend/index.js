...
const client = algoliasearch('RV536TR2S9', '558d57c96e1d2f606ed28de923f59ffd',); /*use your own keys*/
const index = client.initIndex('ges-chat');

admin.initializeApp({
	credential: admin.credential.cert(serviceAccount),
	databaseURL: "https://ges-chat-engage-default-rtdb.firebaseio.com/"
  });
